...
import owlapitest.LabelExtractor;
...
*/
    ...
    public static void main(String[] args) throws OWLException,
        ...
        String onto = "http://rpc295.cs.man.ac.uk:8080/repository/download?ontology=http://www.co-ode.org/ontologies/pizza/pizza.owl&format=RDF/XML";
        
        OWLOntologyManager manager = OWLManager.createOWLOntologyManager();
        // We load an ontology from the URI specified
        // on the command line
        System.out.println(onto);
        IRI documentIRI = IRI.create(onto);
